...
export const colorClassesAlt: Record<CommomColors, Theme> = {
  "pastel-red": {
    bg: "bg-pastel-red",
    bgSoft: "bg-pastel-red/50",
    bgSofter: "bg-pastel-red/18",
    border: "border-pastel-red",
    text: "text-pastel-red",
  },
  "pastel-blue": {
    bg: "bg-pastel-blue",
    bgSoft: "bg-pastel-blue/50",
    bgSofter: "bg-pastel-blue/18",
    border: "border-pastel-blue",
    text: "text-pastel-blue",
  },
  "pastel-pink": {
    bg: "bg-pastel-pink",
    bgSoft: "bg-pastel-pink/50",
    bgSofter: "bg-pastel-pink/18",
    border: "border-pastel-pink",
    text: "text-pastel-pink",
  },
  "pastel-purple": {
    bg: "bg-pastel-purple",
    bgSoft: "bg-pastel-purple/50",
    bgSofter: "bg-pastel-purple/18",
    border: "border-pastel-purple",
    text: "text-pastel-purple",
  },
  "pastel-green": {
    bg: "bg-pastel-green",
    bgSoft: "bg-pastel-green/50",
    bgSofter: "bg-pastel-green/18",
    border: "border-pastel-green",
    text: "text-pastel-green",
  },
  "pastel-yellow": {
    bg: "bg-pastel-yellow",
    bgSoft: "bg-pastel-yellow/50",
    bgSofter: "bg-pastel-yellow/18",
    border: "border-pastel-yellow",
    text: "text-pastel-yellow",
  },
  "pastel-orange": {
    bg: "bg-pastel-orange",
    bgSoft: "bg-pastel-orange/50",
    bgSofter: "bg-pastel-orange/18",
    border: "border-pastel-orange",
    text: "text-pastel-orange",
  },
  "pastel-cyan": {
    bg: "bg-pastel-cyan",
    bgSoft: "bg-pastel-cyan/50",
    bgSofter: "bg-pastel-cyan/18",
    border: "border-pastel-cyan",
    text: "text-pastel-cyan",
  },
  "pastel-mint": {
    bg: "bg-pastel-mint",
    bgSoft: "bg-pastel-mint/50",
    bgSofter: "bg-pastel-mint/18",
    border: "border-pastel-mint",
    text: "text-pastel-mint",
  },
  "pastel-peach": {
    bg: "bg-pastel-peach",
    bgSoft: "bg-pastel-peach/50",
    bgSofter: "bg-pastel-peach/18",
    border: "border-pastel-peach",
    text: "text-pastel-peach",
  },
  "pastel-lavender": {
    bg: "bg-pastel-lavender",
    bgSoft: "bg-pastel-lavender/50",
    bgSofter: "bg-pastel-lavender/18",
